...
- `widget.html` – Badge markup with conditional visibility
- `widget.css` – Keyframe animation and badge styling
- `widget.client.js` – Logic to trigger or reset badge visibility

## 🚀 How to Use

1. Copy the HTML, CSS, and client script into your custom Service Portal widget.
